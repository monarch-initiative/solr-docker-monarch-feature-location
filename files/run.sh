...
mkdir -p /data/json
/data/solr-6.2.1/bin/solr start
cd /data/golr-loader && java -Xmx100G -Dlogback.configurationFile=file:/data/logback.xml -jar target/golr-loader-0.0.1-SNAPSHOT.jar -g /data/graph.yaml -q /data/monarch-cypher-queries/src/main/cypher/feature-location -s http://localhost:8983/solr/feature-location
curl http://localhost:8983/solr/feature-location/update?optimize=true
/data/solr-6.2.1/bin/solr stop
