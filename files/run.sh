...
mkdir -p /data/json
/data/solr-6.2.1/bin/solr start
cd /data/golr-loader && java -Xmx100G -Dlog4j.configuration=file:/data/log4j.properties -jar target/golr-loader-0.0.1-SNAPSHOT.jar -g /data/graph.yaml -q /data/monarch-cypher-queries/src/main/cypher/feature-location -o /data/json/ -s http://localhost:8983/solr/feature-location
/data/solr-6.2.1/bin/solr stop
